...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 10, 2024 lúc 04:59 AM
...
--
-- Đang đổ dữ liệu cho bảng `application_category`
--
...
--
-- Cấu trúc bảng cho bảng `application_category_detail`
--
...
--
-- Đang đổ dữ liệu cho bảng `application_category_detail`
--
...
--
-- Cấu trúc bảng cho bảng `application_framework`
--
...
--
-- Đang đổ dữ liệu cho bảng `application_framework`
--
...
--
-- Cấu trúc bảng cho bảng `application_framework_detail`
--
...
--
-- Đang đổ dữ liệu cho bảng `application_framework_detail`
--
...
--
-- Cấu trúc bảng cho bảng `application_platform`
--
...
--
-- Đang đổ dữ liệu cho bảng `application_platform`
--
...
--
-- Cấu trúc bảng cho bảng `application_platform_detail`
--
...
--
-- Đang đổ dữ liệu cho bảng `application_platform_detail`
--
...
--
-- Cấu trúc bảng cho bảng `application_type`
--
...
--
-- Đang đổ dữ liệu cho bảng `application_type`
--
...
--
-- Cấu trúc bảng cho bảng `developers_skills`
--
...
--
-- Đang đổ dữ liệu cho bảng `developers_skills`
--
...
--
-- Cấu trúc bảng cho bảng `header_nav`
--
...
--
-- Đang đổ dữ liệu cho bảng `header_nav`
--
...
--
-- Cấu trúc bảng cho bảng `header_sub_nav`
--
...
--
-- Đang đổ dữ liệu cho bảng `header_sub_nav`
--
...
--
-- Chỉ mục cho bảng `application_category`
--
ALTER TABLE `application_category`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `application_category_detail`
--
...
--
-- Chỉ mục cho bảng `application_framework`
--
ALTER TABLE `application_framework`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `application_framework_detail`
--
...
--
-- Chỉ mục cho bảng `application_platform`
--
ALTER TABLE `application_platform`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `application_platform_detail`
--
...
--
-- Chỉ mục cho bảng `application_type`
--
...
--
-- Chỉ mục cho bảng `developers_skills`
--
...
--
-- Chỉ mục cho bảng `header_nav`
--
ALTER TABLE `header_nav`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `header_sub_nav`
--
...
--
-- AUTO_INCREMENT cho bảng `application_category`
--
ALTER TABLE `application_category`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `application_framework`
--
ALTER TABLE `application_framework`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `application_platform`
--
ALTER TABLE `application_platform`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `application_type`
--
ALTER TABLE `application_type`
...
--
-- AUTO_INCREMENT cho bảng `header_nav`
--
ALTER TABLE `header_nav`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `header_sub_nav`
--
ALTER TABLE `header_sub_nav`
...
--
-- Các ràng buộc cho bảng `application_category_detail`
--
ALTER TABLE `application_category_detail`
...
--
-- Các ràng buộc cho bảng `application_framework_detail`
--
ALTER TABLE `application_framework_detail`
...
--
-- Các ràng buộc cho bảng `application_platform_detail`
--
ALTER TABLE `application_platform_detail`
...
--
-- Các ràng buộc cho bảng `developer`
--
ALTER TABLE `developer`
...
--
-- Các ràng buộc cho bảng `developers_skills`
--
ALTER TABLE `developers_skills`
...
--
-- Các ràng buộc cho bảng `header_sub_nav`
--
ALTER TABLE `header_sub_nav`
